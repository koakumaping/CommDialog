class cDialog {
    constructor(type, ...args) {
        ...
        this.config = {
            ...
            confirmButtonClass: 'c-dialog-default',
            cancelButtonClass: 'c-dialog-default',
    ...
    init() {
        this.close = '<div class="c-dialog-close">x</div>'

        this.title = `<div class="c-dialog-title">${this.config.title}</div>`

        this.content = `<div class="c-dialog-content">${this.config.content}</div>`

        this.buttons = ''

        this.confirmButton = `<button type="button" class="c-dialog-btn c-dialog-confirm">
            ${this.config.confirmButton}
        </button>`

        this.cancelButton = `<button type="button" class="c-dialog-btn c-dialog-cancel">
    ...
    bindEvent() {
        const $confirm = this.box.querySelector('.c-dialog-confirm')
        const $cancel = this.box.querySelector('.c-dialog-cancel')
        const $close = this.box.querySelector('.c-dialog-close')
        const $bg = this.elemet.querySelector('.c-dialog-bg')
    ...
    renderButtons() {
        ...
        this.buttonsWarp = `<div class="c-dialog-buttons">${this.buttons}</div>`
    }

    renderBox() {
        this.body = `
            <div class="c-dialog-bg" style="opacity: ${this.config.opacity}"></div>
            <div class="c-dialog-warp">
    ...
    renderWarp() {
        this.addClass(this.hodor, 'c-dialog')
    ...
    setElements() {
        ...
        this.box = this.elemet.querySelector('.c-dialog-box')
    }

    setCenter() {
        const dialogHeight = document.querySelector('.c-dialog-container').offsetHeight
